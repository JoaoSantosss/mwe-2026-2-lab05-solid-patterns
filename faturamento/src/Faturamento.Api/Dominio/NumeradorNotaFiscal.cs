...
public sealed class NumeradorNotaFiscal
{
    ...
    private static readonly Lazy<NumeradorNotaFiscal> _instancia = new Lazy<NumeradorNotaFiscal>(() => new NumeradorNotaFiscal());
    ...
    {
        int atual = Interlocked.Increment(ref _ultimo);
