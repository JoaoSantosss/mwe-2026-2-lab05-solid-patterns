 ...
 *
 * <p>
 * <strong>TODO-1 (DIP):</strong> esta classe é a implementação concreta, e é
 ...
 * pacote {@code dominio}, sem mudar o corpo de nenhum método.
 * </p>
 *
 * <p>
 * Os métodos são {@code public} e não são {@code final} de propósito: é o
 * que permite, hoje, o dublê de teste herdar desta classe. Depois do TODO-1
 * esse truque some, e é justamente esse o ponto.
 * </p>
 */
@Repository
